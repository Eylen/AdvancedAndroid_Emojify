...
class Emojifier {
    ...
    public static void getClassifications(Face face){
        Log.d(LOG_TAG, "Probability of having the left eye open: " + face.getIsLeftEyeOpenProbability());
        Log.d(LOG_TAG, "Probability of having the right eye open: " + face.getIsRightEyeOpenProbability());
        Log.d(LOG_TAG, "Probability of smiling: " + face.getIsSmilingProbability());
